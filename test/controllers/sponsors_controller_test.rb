...
class SponsorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sponsor" do
    assert_difference('Sponsor.count') do
      post sponsors_url, params: { sponsor: { has_won: @sponsor.has_won, name: @sponsor.name, prizes: @sponsor.prizes } }
    end
  ...
  test "should update sponsor" do
    patch sponsor_url(@sponsor), params: { sponsor: { has_won: @sponsor.has_won, name: @sponsor.name, prizes: @sponsor.prizes } }
